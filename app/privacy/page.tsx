...
export const metadata: Metadata = {
  title: 'Privacy Policy - Helpers Hub',
  description: 'Privacy policy for Helpers Hub.',
}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 mb-8">
            Helpers Hub ("we," "us," "our," or "Company") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
          </p>
          ...
          <h2 className="text-3xl font-bold mb-6 mt-12">Use of Your Information</h2>
          <p className="text-gray-600 mb-4">
          ...
          <h2 className="text-3xl font-bold mb-6 mt-12">Disclosure of Your Information</h2>
          <p className="text-gray-600 mb-8">
          ...
          <h2 className="text-3xl font-bold mb-6 mt-12">Security of Your Information</h2>
          <p className="text-gray-600 mb-8">
          ...
          <p className="text-gray-600">
            ...
            <strong>Helpers Hub</strong><br />
            123 Care Street<br />
            Community City, CC 12345<br />
            Email: privacy@helpershub.org<br />
            Phone: (555) 123-4567
          </p>
        </div>
      </section>
